#> yrfs_reversi:white/cpu/count_disc_3
#
# 石の数を数えてスコアから引く
#
...
# 黒と白の差を引く
  scoreboard players operation cpu_white_count_3 reversi -= cpu_black_count_3 reversi
  scoreboard players operation cpu_white_count_3 reversi -= cpu_white_count_1 reversi
  scoreboard players operation cpu_white_count_3 reversi *= cpu_disc_count reversi
  scoreboard players operation @s reversi_cpu_surrounded -= cpu_white_count_3 reversi
