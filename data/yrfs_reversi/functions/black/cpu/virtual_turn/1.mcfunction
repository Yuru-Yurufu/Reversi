...
# as,at: server
#
# @within function yrfs_reversi:black/cpu/virtual_turn/init
...
# タグ持ちの場所に置く
  data modify entity @e[type=marker,tag=reversi_marker,tag=reversi_cpu_now_placed_here,limit=1] data.cpu.disc set value "black"

# 一つも置けない場合パスをする
  execute unless entity @e[type=marker,tag=reversi_marker,tag=reversi_can_place_here] run schedule function yrfs_reversi:black/pass 7
...
# ひっくり返す
  execute as @e[type=marker,tag=reversi_marker,tag=reversi_cpu_now_placed_here] if data entity @s {data:{can_reverse_direction:{nw:true}}} at @s run function yrfs_reversi:black/cpu/rotation {position:"~1 ~ ~1"}
  execute as @e[type=marker,tag=reversi_marker,tag=reversi_cpu_now_placed_here] if data entity @s {data:{can_reverse_direction:{n:true}}} at @s run function yrfs_reversi:black/cpu/rotation {position:"~ ~ ~1"}
  execute as @e[type=marker,tag=reversi_marker,tag=reversi_cpu_now_placed_here] if data entity @s {data:{can_reverse_direction:{ne:true}}} at @s run function yrfs_reversi:black/cpu/rotation {position:"~-1 ~ ~1"}
  execute as @e[type=marker,tag=reversi_marker,tag=reversi_cpu_now_placed_here] if data entity @s {data:{can_reverse_direction:{w:true}}} at @s run function yrfs_reversi:black/cpu/rotation {position:"~1 ~ ~"}
  execute as @e[type=marker,tag=reversi_marker,tag=reversi_cpu_now_placed_here] if data entity @s {data:{can_reverse_direction:{e:true}}} at @s run function yrfs_reversi:black/cpu/rotation {position:"~-1 ~ ~"}
  execute as @e[type=marker,tag=reversi_marker,tag=reversi_cpu_now_placed_here] if data entity @s {data:{can_reverse_direction:{sw:true}}} at @s run function yrfs_reversi:black/cpu/rotation {position:"~1 ~ ~-1"}
  execute as @e[type=marker,tag=reversi_marker,tag=reversi_cpu_now_placed_here] if data entity @s {data:{can_reverse_direction:{s:true}}} at @s run function yrfs_reversi:black/cpu/rotation {position:"~ ~ ~-1"}
  execute as @e[type=marker,tag=reversi_marker,tag=reversi_cpu_now_placed_here] if data entity @s {data:{can_reverse_direction:{se:true}}} at @s run function yrfs_reversi:black/cpu/rotation {position:"~-1 ~ ~-1"}
...
# 55ターン目以降は石の数も考慮に入れる
  execute if score turn reversi matches 55.. run function yrfs_reversi:black/cpu/count_disc_1
...
# 2ターン目に進む
  execute as @e[type=marker,tag=reversi_marker,tag=reversi_cpu_now_placed_here_] run function yrfs_reversi:black/cpu/virtual_turn/2
