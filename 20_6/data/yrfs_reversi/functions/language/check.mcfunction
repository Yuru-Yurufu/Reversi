...
# summon
  summon item -15 2 -7 {Tags:["reversi","reversi_lang_item"],NoGravity:1b,Age:32768,PickupDelay:32767,Invulnerable:1b,Item:{id:"minecraft:command_block",count:1b,components:{"minecraft:enchantments":{levels:{"minecraft:unbreaking":10}}}}}
