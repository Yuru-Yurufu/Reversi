...
# プレイヤーヘッドの設定
  summon item_display -0.9 3.8 15.2 {Tags:["reversi","reversi_gui","reversi_gui_display","reversi_gui_white_player","reversi_gui_white_player_unset"],item:{id:"player_head",count:1b},transformation:{left_rotation:{angle:0,axis:[0f,0f,1f]},right_rotation:{angle:0,axis:[0f,0f,1f]},translation:[0f,0f,0f],scale:[0.9f,0.9f,0.9f]},brightness:{sky:15,block:10}}
