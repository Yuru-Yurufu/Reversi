...
# 元の位置に戻す
  ...
  execute as @a[tag=reversi_result_viewer] at @s unless entity @e[type=item_display,tag=reversi_camera,limit=1,distance=...1] run function yrfs_reversi:result/uuid_copy
